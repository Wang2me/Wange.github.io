...
markers.dog1 = createMarker({ lat:	30.0454 ,lng:31.2457}, 'dog','埃及開羅',{ A:['dog'], B:['史前至夏商周'],C:['宗教信仰'],D:[''],E:['非洲'] }
   ,{  title: '描述',
       ...
       ,imag:'media/dog/212 Great Sphinx of Giza.jpg'
       ,referenceUrl:'whc.unesco.org/zh/list/86.'
    });


markers.dog2 = createMarker({ lat:	37.8201	,lng:22.6513}, 'dog','希臘尼米亞',{ A:['dog'], B:['史前至夏商周'],C:['宗教信仰'],D:[''],E:['歐洲'] },
   {title: '描述'  
	...
	,image:'media/dog/213 Terracotta amphora (jar).jpg'
	,referenceUrl:''
    });

markers.dog3 = createMarker({ lat:	25.3176	,lng:82.9739 }, 'dog','印度瓦拉納西',{ A:['dog'], B:['史前至夏商周'],C:['宗教信仰'],D:[''],E:['南亞']},
   {title: '描述'  
...
markers.dog7 = createMarker({ lat:	41.1273	,lng:119.740 }, 'dog','遼寧喀左縣',{ A:['dog'],B:['三國兩晉南北朝'],C:['身份象徵'],D:['陸上絲綢之路'],E:['東亞']},
   {title: '描述'  
	...
	,image:'media/dog/219 北凉-272窟龛内南壁-说法图.webp'
	,referenceUrl:''});

markers.dog8 = createMarker({ lat:	40.1130	,lng:94.6618 },'dog','甘肅敦煌',{ A:['dog'],B:['三國兩晉南北朝'],C:['宗教信仰'],D:['陸上絲綢之路'],E:['東亞'] },
   {title: '描述'  
...
markers.dog9 = createMarker({ lat:	15.8801	,lng:108.338 }, 'dog','越南會安',{ A:['dog'],B:['三國兩晉南北朝'],C:['軍事'],D:['陸上絲綢之路'],E:['東南亞'] },
   {title: '描述'  
...
markers.dog10 = createMarker({ lat:	34.6364	,lng:   112.4501 }, 'dog','河南洛陽',{ A:['dog'],B:['三國兩晉南北朝'],C:['宗教信仰'],D:['陸上絲綢之路'],E:['東亞'] },
   {title: '描述'  
...
markers.dog11 = createMarker({ lat:    33.3154	,lng:   44.3660 }, 'dog','伊拉克巴格達',{ A:['dog'],B:['三國兩晉南北朝'],C:['朝貢'],D:['陸上絲綢之路'],E:['西亞'] },
   {title: '描述'  
...
markers.dog12 = createMarker({ lat:    40.5204	,lng:   95.7822 }, 'dog','甘肅瓜州',{ A:['dog'],B:['唐'],C:['宗教信仰'],D:['陸上絲綢之路'],E:['東亞'] },
   {title: '描述'  
	...
	,image:'media/dog/223 榆林窟第25窟-主室西壁北侧-文殊图-中唐.png'
	,referenceUrl:''});

markers.dog13 = createMarker({ lat:    41.7207	,lng:   82.9430 }, 'dog','新疆庫車',{ A:['dog'],B:['唐'],C:['朝貢'],D:['陸上絲綢之路'],E:['東亞'] },
   {title: '描述'  
...
markers.dog14 = createMarker({ lat:    41.7407	,lng:   82.9530 }, 'dog','新疆庫車',{ A:['dog'],B:['唐'],C:['文化娛樂'],D:['陸上絲綢之路'],E:['東亞']},
   {title: '描述'  
...
markers.dog15 = createMarker({ lat:	39.627	,lng:   66.9749 }, 'dog','烏茲別克斯坦撒馬爾罕',{ A:['dog'],B:['唐'],C:['朝貢'],D:['陸上絲綢之路'],E:['中亞'] },
   {title: '描述'  
...
markers.dog16 = createMarker({ lat:	33.5138	,lng:	36.2765 }, 'dog','敘利亞大馬士革',{ A:['dog'],B:['唐'],C:['朝貢'],D:['陸上絲綢之路'],E:['西亞'] },
   {title: '描述'  
...
markers.dog17 = createMarker({ lat:	36.4707	,lng:	52.3466 }, 'dog','伊朗阿莫勒',{ A:['dog'],B:['唐'],C:['朝貢'],D:['陸上絲綢之路'],E:['西亞'] },
   {title: '描述'  
...
markers.dog18 = createMarker({ lat:	41.0082	,lng:	28.9784 }, 'dog','土耳其伊斯坦布爾',{ A:['dog'],B:['唐'],C:['朝貢'],D:['陸上絲綢之路'],E:['歐洲'] },
   {title: '描述'  
...
markers.dog19 = createMarker({ lat:	53.7175	,lng:	91.4292 }, 'dog','俄羅斯亞巴坎',{ A:['dog'],B:['唐'],C:['文化娛樂'],D:['陸上絲綢之路'],E:['北亞'] },
   {title: '描述'  
...
markers.dog20 = createMarker({ lat:	34.7973	,lng:	114.3072 }, 'dog','河南開封',{ A:['dog'],B:['宋' ],C:['文化娛樂'],D:[''],E:['東亞']},
   {title: '描述'  
	...
	,image:'media/dog/231 苏汉臣百子嬉春.png'
	,referenceUrl:''});

markers.dog21 = createMarker({ lat:	34.7970	,lng:	114.3077 }, 'dog','河南開封',{ A:['dog'],B:['宋'],C:['宗教信仰'],D:[''],E:['東亞'] },
   {title: '描述'  
...
markers.dog22 = createMarker({ lat:	15.8801	,lng:	108.338 }, 'dog','越南會安',{ A:['dog'],B:['宋' ],C:['朝貢'],D:['陸上絲綢之路'],E:['東南亞']},
   {title: '描述'  
...
markers.dog23 = createMarker({ lat:	38.1234	,lng:	46.2444}, 'dog','伊朗大不里士',{ A:['dog'],B:['元'],C:['朝貢'],D:['陸上絲綢之路'],E:['西亞'] },
   {title: '描述'  
...
markers.dog24 = createMarker({ lat:	21.3891	,lng:	39.8579 }, 'dog','沙特阿拉伯麥加',{ A:['dog'],B:['元' ],C:['朝貢'],D:['海上絲綢之路'],E:['西亞']},
   {title: '描述'  
...
markers.dog25 = createMarker({ lat:	39.9042	,lng:	116.4074 }, 'dog','北京',{ A:['dog'],B:['明'],C:['身份象徵'],D:[''],E:['東亞'] },
   {title: '描述'  
...
markers.dog26 = createMarker({ lat:	39.9245	,lng:	116.4074 }, 'dog','北京',{ A:['dog'],B:['明'],C:['朝貢'],D:[''],E:['東亞'] },
   {title: '描述'  
...
markers.dog27 = createMarker({ lat:	42.9513	,lng:	89.1895 }, 'dog','新疆吐魯番',{ A:['dog'],B:['明' ],C:['朝貢'],D:['陸上絲綢之路'],D:['海上絲綢之路'],E:['東亞']},
   {title: '描述'  
...
markers.dog28 = createMarker({ lat:	34.3462	,lng:	62.2047 }, 'dog','阿富汗赫拉特',{ A:['dog'],B:['明'],C:['朝貢'],D:['陸上絲綢之路'],E:['西亞'] },
   {title: '描述'  
...
markers.dog29 = createMarker({ lat:	13.7563	,lng:	100.5018 }, 'dog','泰國曼谷',{ A:['dog'],B:['明'],C:['朝貢'],D:['海上絲綢之路'],E:['東南亞'] },
   {title: '描述'  
...
markers.dog30 = createMarker({ lat:	12.7855	,lng:	45.0185 }, 'dog','也門亞丁',{ A:['dog'],B:['明'],C:['朝貢'],D:['海上絲綢之路'],E:['西亞'] },
   {title: '描述'  
...
markers.dog31 = createMarker({ lat:	27.1377	,lng:	57.0684 }, 'dog','伊朗米纳卜',{ A:['dog'],B:['明'],C:['朝貢'],D:['海上絲綢之路' ],E:['西亞']},
   {title: '描述'  
...
markers.dog32 = createMarker({ lat:	21.3891	,lng:	39.8379 }, 'dog','沙特阿拉伯麥加',{ A:['dog'],B:['明'],C:['朝貢'],D:['海上絲綢之路'],E:['西亞'] },
   {title: '描述'  
...
markers.dog33 = createMarker({ lat:	41.0182	,lng:	28.9784 }, 'dog','土耳其伊斯坦布爾',{ A:['dog'],B:['明'],C:['朝貢'],D:['海上絲綢之路'],E:['歐洲'] },
   {title: '描述'  
...
markers.dog34 = createMarker({ lat:	-25.9682 ,lng:	32.5729 }, 'dog','莫桑比克馬普托',{ A:['dog'],B:['清'],C:['朝貢'],D:['海上絲綢之路'],E:['非洲'] },
   {title: '描述'  
...
var dogs = [
    ...
    'dog11', 'dog12', 'dog13', 'dog14', 'dog15', 'dog16', 'dog17', 'dog18', 'dog19',
    'dog20', 'dog21', 'dog22', 'dog23', 'dog24', 'dog25', 'dog26', 'dog27', 'dog28',
    'dog29', 'dog30', 'dog31', 'dog32', 'dog33', 'dog34'
];

for (var i = 0; i < dogs.length; i++) {
    window[dogs[i]] = markers[dogs[i]];
}
...
var newcoords_dog4 = { lat: 34.637, lng: 112.452 };
var newCoords_dog4= RandomCoords(newcoords_dog4);
var newcoords_dog5 = { lat: 34.637, lng: 112.452 };
var newCoords_dog5= RandomCoords(newcoords_dog5);
var newcoords_dog6 = { lat: 34.637, lng: 112.452 };
var newCoords_dog6= RandomCoords(newcoords_dog6);
var newcoords_dog11 = { lat: 34.637, lng: 112.452 };
var newCoords_dog11= RandomCoords(newcoords_dog11);

var newcoords_dog13 = { lat: 34.2665, lng: 108.9531 };
var newCoords_dog13= RandomCoords(newcoords_dog13);
var newcoords_dog14 = { lat: 34.2665, lng: 108.9531 };
var newCoords_dog14= RandomCoords(newcoords_dog14);
var newcoords_dog15 = { lat: 34.2665, lng: 108.9531 };
var newCoords_dog15= RandomCoords(newcoords_dog15);
var newcoords_dog16 = { lat: 34.2665, lng: 108.9531 };
var newCoords_dog16= RandomCoords(newcoords_dog16);
var newcoords_dog17 = { lat: 34.2665, lng: 108.9531 };
var newCoords_dog17= RandomCoords(newcoords_dog17);
var newcoords_dog18 = { lat: 34.2665, lng: 108.9531 };
var newCoords_dog18= RandomCoords(newcoords_dog18);

var newCoords_dog22 = { lat: 34.7845	,lng:	114.2722 };

var newcoords_dog23 =   { lat: 39.9042	,lng:	116.4074  };
var newCoords_dog23= RandomCoords(newcoords_dog23);
var newCoords_dog24_1 = { lat: 30.2925 ,lng:   120.1145  };
var newcoords_dog24_2 = { lat: 39.9042	,lng:	116.4074  };
var newCoords_dog24_2= RandomCoords(newcoords_dog24_2);
var newCoords_dog27_1 = { lat: 23.1298 ,lng:   113.2623  }
var newcoords_dog27_2 = { lat:	39.9042	,lng:	116.4074  };
var newCoords_dog27_2= RandomCoords(newcoords_dog27_2);

var newcoords_dog28 = { lat: 39.9042	,lng:	116.4074 };
var newCoords_dog28= RandomCoords(newcoords_dog28);
var newcoords_dog29 = { lat: 39.9042	,lng:	116.4074 };
var newCoords_dog29= RandomCoords(newcoords_dog29);
var newcoords_dog30 = { lat: 39.9042	,lng:	116.4074 };
var newCoords_dog30= RandomCoords(newcoords_dog30);
var newcoords_dog31 = { lat: 39.9042	,lng:	116.4074 };
var newCoords_dog31= RandomCoords(newcoords_dog31);
var newcoords_dog32 = { lat: 39.9042	,lng:	116.4074 };
var newCoords_dog32= RandomCoords(newcoords_dog32);
var newcoords_dog33 = { lat: 39.9042	,lng:	116.4074 };
var newCoords_dog33= RandomCoords(newcoords_dog33);




var newCoords_dog34_1 = { lat: 15.2841,lng: 73.9831};//yindu
var newCoords_dog34_2 = { lat: 22.1124,lng : 113.5651};//anmen
var newCoords_dog34_3 = { lat: 39.9042	,lng:	116.4074 };//bj
...
slider.addEventListener('input', function() {
    ...
    if(currentValue>0&&currentValue<1000)
    {
        ...
        [dog4, dog5, dog6,dog7, dog8, dog9, dog10, dog11, dog12, dog13, dog14, dog15, dog16, dog17, dog18, dog19, dog20, dog21, dog22, dog23, dog24, dog25, dog26, dog27, dog28, dog29, dog30, dog31, dog32, dog33, dog34]);
    ...
    if (currentValue >= 1000 && currentValue < 2000) {
        ...
        toggleMarkers([dog1, dog2, dog3,dog4, dog5, dog6], 
        [dog7, dog8, dog9, dog10, dog11, dog12, dog13, dog14, dog15, dog16, dog17, dog18, dog19, dog20, dog21, dog22, dog23, dog24, dog25, dog26, dog27, dog28, dog29, dog30, dog31, dog32, dog33, dog34]);


        
        // 在1000到2000的范围内时执行标记位置的更新
        if(currentValue==1000){
            markers.dog4.setPosition(initialCoords_dog4);
            markers.dog5.setPosition(initialCoords_dog5);
            markers.dog6.setPosition(initialCoords_dog6);
           
            
        }
        var points_4 = [initialCoords_dog4, dunhuang,jiuquan, newCoords_dog4, newCoords_dog4,];
        var points_5 = [initialCoords_dog5, dunhuang,zhangye,  newCoords_dog5,  newCoords_dog5];
        var points_6 = [initialCoords_dog6, dunhuang, wuwei, newCoords_dog6, newCoords_dog6];
    // 计算当前阶段的目标点的索引
    ...
    // 设置dog24的位置
        dog4.setPosition({ lat: interpolatedLat_4, lng: interpolatedLng_4 });
        dog5.setPosition({ lat: interpolatedLat_5, lng: interpolatedLng_5 });     
        dog6.setPosition({ lat: interpolatedLat_6, lng: interpolatedLng_6 });


    }
    //三国
    if (currentValue >= 2000 && currentValue <3000) {
        toggleMarkers([dog1, dog2, dog3,dog4, dog5, dog6,dog7, dog8, dog9, dog10, dog11], 
        [dog12, dog13, dog14, dog15, dog16, dog17, dog18, dog19, dog20, dog21, dog22, dog23, dog24, dog25, dog26, dog27, dog28, dog29, dog30, dog31, dog32, dog33, dog34]);


        if(currentValue>=2000){
            markers.dog4.setPosition(newCoords_dog4);
            markers.dog5.setPosition(newCoords_dog5);
            markers.dog6.setPosition(newCoords_dog6);


            // dog11.setPosition(initialCoords_dog11);

        }
        var points_11 = [initialCoords_dog11, dunhuang, wuwei, newCoords_dog11, newCoords_dog11,];
        ...
        dog11.setPosition({ lat: interpolatedLat_11, lng: interpolatedLng_11 });
    ...
    if(currentValue>=3000&&currentValue<4000){
        ...
        markers.dog5.setPosition(newCoords_dog5);
        markers.dog6.setPosition(newCoords_dog6);
        markers.dog11.setPosition(newCoords_dog11);

        // dog13.setPosition(initialCoords_dog13);
        // dog14.setPosition(initialCoords_dog14);
        // dog15.setPosition(initialCoords_dog15);
        // dog16.setPosition(initialCoords_dog16);
        // dog17.setPosition(initialCoords_dog17);
        // dog18.setPosition(initialCoords_dog18);
        }
        
    }
    //唐
    if (currentValue >= 4000 && currentValue < 5000) {
        toggleMarkers([dog1, dog2, dog3,dog4, dog5, dog6,dog7, dog8, dog9, dog10, dog11,dog12, dog13, dog14, dog15, dog16, dog17, dog18, dog19], 
        [dog20, dog21, dog22, dog23, dog24, dog25, dog26, dog27, dog28, dog29, dog30, dog31, dog32, dog33, dog34]);
        ...
        var points_13 = [initialCoords_dog13, dunhuang,jiuquan, newCoords_dog13, newCoords_dog13];
        var points_14 = [initialCoords_dog14, dunhuang,zhangye, newCoords_dog14, newCoords_dog14];
        var points_15 = [initialCoords_dog15, dunhuang,wuwei, newCoords_dog15, newCoords_dog15];
        var points_16 = [initialCoords_dog16, jiuquan,zhangye, newCoords_dog16, newCoords_dog16];
        var points_17 = [initialCoords_dog17, jiuquan,wuwei, newCoords_dog17, newCoords_dog17];
        var points_18 = [initialCoords_dog18, dunhuang,zhangye,wuwei, newCoords_dog18, newCoords_dog18];
    ...
    // 计算插值百分比
        var percentage_13 = speeddog13*(currentValue - 4000) % (1000 / (points_13.length-1)) / (1000 / (points_13.length-1));
        var percentage_14 = speeddog14*(currentValue - 4000) % (1000 / (points_14.length-1)) / (1000 / (points_14.length-1));
        var percentage_15 = speeddog15*(currentValue - 4000) % (1000 / (points_15.length-1)) / (1000 / (points_15.length-1));
        var percentage_16 = speeddog16*(currentValue - 4000) % (1000 / (points_16.length-1)) / (1000 / (points_16.length-1));
        var percentage_17 = speeddog17*(currentValue - 4000) % (1000 / (points_17.length-1)) / (1000 / (points_17.length-1));
        var percentage_18 = speeddog18*(currentValue - 4000) % (1000 / (points_18.length-1)) / (1000 / (points_18.length-1));
    ...
    // 计算插值的新位置
        ...
        var interpolatedLat_13 = points_13[targetIndex_13].lat + latDiff * percentage_13*speeddog13;
        var interpolatedLng_13 = points_13[targetIndex_13].lng + lngDiff * percentage_13*speeddog13;
        ...
        var interpolatedLat_14 = points_14[targetIndex_14].lat + latDiff * percentage_14*speeddog14;
        var interpolatedLng_14 = points_14[targetIndex_14].lng + lngDiff * percentage_14*speeddog14;
        ...
        var interpolatedLat_15 = points_15[targetIndex_15].lat + latDiff * percentage_15*speeddog15;
        var interpolatedLng_15 = points_15[targetIndex_15].lng + lngDiff * percentage_15*speeddog15;
        ...
        var interpolatedLat_16 = points_16[targetIndex_16].lat + latDiff * percentage_16*speeddog16;
        var interpolatedLng_16 = points_16[targetIndex_16].lng + lngDiff * percentage_16*speeddog16;
        ...
        var interpolatedLat_17 = points_17[targetIndex_17].lat + latDiff * percentage_17*speeddog17;
        var interpolatedLng_17 = points_17[targetIndex_17].lng + lngDiff * percentage_17*speeddog17;
        ...
        var interpolatedLat_18 = points_18[targetIndex_18].lat + latDiff * percentage_18*speeddog18;
        var interpolatedLng_18 = points_18[targetIndex_18].lng + lngDiff * percentage_18*speeddog18;
    // 设置dog213的位置
        dog13.setPosition({ lat: interpolatedLat_13, lng: interpolatedLng_13 });
        dog14.setPosition({ lat: interpolatedLat_14, lng: interpolatedLng_14 });     
        dog15.setPosition({ lat: interpolatedLat_15, lng: interpolatedLng_15 });
        dog16.setPosition({ lat: interpolatedLat_16, lng: interpolatedLng_16 });
        dog17.setPosition({ lat: interpolatedLat_17, lng: interpolatedLng_17 });
        dog18.setPosition({ lat: interpolatedLat_18, lng: interpolatedLng_18 });

    }
    //宋
    if (currentValue >= 5000 && currentValue <6000) {
        toggleMarkers([dog1, dog2, dog3,dog4, dog5, dog6,dog7, dog8, dog9, dog10, dog11,dog12, dog13, dog14, dog15, dog16, dog17, dog18, dog19,dog20, dog21, dog22], 
        [dog23, dog24, dog25, dog26, dog27, dog28, dog29, dog30, dog31, dog32, dog33, dog34]);

        // 在2000到3000的范围内时执行标记位置的更新
        if (currentValue >= 5000) {
            // 如果滑块值为4000，将标记位置还原到初始位置
            dog4.setPosition(newCoords_dog4);
            dog5.setPosition(newCoords_dog5);
            dog6.setPosition(newCoords_dog6);
            dog11.setPosition(newCoords_dog11);
            dog13.setPosition(newCoords_dog13);
            dog14.setPosition(newCoords_dog14);
            dog15.setPosition(newCoords_dog15);
            dog16.setPosition(newCoords_dog16);
            dog17.setPosition(newCoords_dog17);
            dog18.setPosition(newCoords_dog18);
            

            // dog22.setPosition(initialCoords_dog22);

        } else {
            // 计算dog22的新位置
            var latDiff22 = newCoords_dog22.lat - initialCoords_dog22.lat();
            var lngDiff22 = newCoords_dog22.lng - initialCoords_dog22.lng();
            var interpolatedLat22 = initialCoords_dog22.lat() + (latDiff22 * ((currentValue - 5000) / 1000));
            var interpolatedLng22 = initialCoords_dog22.lng() + (lngDiff22 * ((currentValue - 5000) / 1000));
            dog22.setPosition({ lat: interpolatedLat22, lng: interpolatedLng22 });
        }
    }
    //元
    if (currentValue >= 6000 && currentValue <7000) {
        toggleMarkers([dog1, dog2, dog3,dog4, dog5, dog6,dog7, dog8, dog9, dog10, dog11,dog12, dog13, dog14, dog15, dog16, dog17, dog18, dog19,dog20, dog21, dog22,dog23, dog24], 
        [dog25, dog26, dog27, dog28, dog29, dog30, dog31, dog32, dog33, dog34]);
        ...
        if(currentValue>=6000){
            ...
            dog17.setPosition(newCoords_dog17);
            dog18.setPosition(newCoords_dog18);
            dog22.setPosition(newCoords_dog22);

            // dog23.setPosition(initialCoords_dog23);
            // dog24.setPosition(initialCoords_dog24_2);

  
        }
        var points_23 = [initialCoords_dog23, dunhuang, wuwei, newCoords_dog23, newCoords_dog23];
        var points_24 = [initialCoords_dog24, jibudi,guli, xilan, palk, maliujia, newCoords_dog24_1, newCoords_dog24_2, newCoords_dog24_2];
    // 计算当前阶段的目标点的索引
    ...
    // 设置dog24的位置
        dog23.setPosition({ lat: interpolatedLat_23, lng: interpolatedLng_23 });
        dog24.setPosition({ lat: interpolatedLat_24, lng: interpolatedLng_24 });     
   ...
   //明
    if(currentValue >=7000 && currentValue <8000){
        ...
        if(currentValue>=7000){
            ...
            dog18.setPosition(newCoords_dog18);
            dog22.setPosition(newCoords_dog22);
            dog23.setPosition(newCoords_dog23);
            dog24.setPosition(newcoords_dog24_2);

            // dog27.setPosition(initialCoords_dog27);
            // dog28.setPosition(initialCoords_dog28);
            // dog29.setPosition(initialCoords_dog29);
            // dog30.setPosition(initialCoords_dog30);
            // dog31.setPosition(initialCoords_dog31);
            // dog32.setPosition(initialCoords_dog32);
            // dog33.setPosition(initialCoords_dog33);
        ...
        if(currentValue>=7000 && currentValue< 7000+(1000/3) ){
            ...
            // 计算dog28_1的新位置
            var latDiff28_1 = dunhuang.lat - initialCoords_dog28.lat();
            var lngDiff28_1 = dunhuang.lng - initialCoords_dog28.lng();
            var interpolatedLat28_1 = initialCoords_dog28.lat() + (latDiff28_1 * ((currentValue - 7000) / (1000/3)));
            var interpolatedLng28_1 = initialCoords_dog28.lng() + (lngDiff28_1 * ((currentValue - 7000) / (1000/3)));
            dog28.setPosition({ lat: interpolatedLat28_1, lng: interpolatedLng28_1 })
            }
        ...
        if (currentValue >= 7000+(1000/3) && currentValue < 7000+(1000/3)+(1000/3)) {
            if (currentValue===(7000+(1000/3))){
                dog28.setPosition({ dunhuang });
                
            }else 
            {
            var latDiff28_2 = wuwei.lat - dog28.getPosition().lat();
            var lngDiff28_2 = wuwei.lng - dog28.getPosition().lng();
            var interpolatedLat28_2 = dog28.getPosition().lat() + (latDiff28_2 * ((currentValue - (7000+(1000/3))) / (1000/3)));
            var interpolatedLng28_2 = dog28.getPosition().lng() + (lngDiff28_2 * ((currentValue - (7000+(1000/3))) / (1000/3)));
            dog28.setPosition({ lat: interpolatedLat28_2, lng: interpolatedLng28_2 });
        ...
        if (currentValue >= 7000+(1000/3)+(1000/3) && currentValue < 8000) {
            if (currentValue===(7000+(1000/3)+(1000/3))){
                dog28.setPosition({ wuwei });
                


            }else
            {
            var latDiff28_3 = newCoords_dog28.lat - dog28.getPosition().lat();
            var lngDiff28_3 = newCoords_dog28.lng - dog28.getPosition().lng();
            var interpolatedLat28_3 = dog28.getPosition().lat() + (latDiff28_3 * ((currentValue - (7000+(1000/3)+(1000/3))) / (1000/3)));
            var interpolatedLng28_3 = dog28.getPosition().lng() + (lngDiff28_3 * ((currentValue - (7000+(1000/3)+(1000/3))) / (1000/3)));
            dog28.setPosition({ lat: interpolatedLat28_3, lng: interpolatedLng28_3 });
        ...
        if(currentValue>=7000 && currentValue< 7250 ){
            ...
            // 计算dog27_1的新位置
            var latDiff27_1 = dunhuang.lat - initialCoords_dog27.lat();
            var lngDiff27_1 = dunhuang.lng - initialCoords_dog27.lng();
            var interpolatedLat27_1 = initialCoords_dog27.lat() + (latDiff27_1 * ((currentValue -7000) / 250));
            var interpolatedLng27_1 = initialCoords_dog27.lng() + (lngDiff27_1 * ((currentValue - 7000) / 250));
            dog27.setPosition({ lat: interpolatedLat27_1, lng: interpolatedLng27_1 })
            }
            
        }  
        if (currentValue >= 7250 && currentValue < 7500) {
            if (currentValue===7250){
                dog27.setPosition({ dunhuang });
            }else
            {
            var latDiff27_2 = wuwei.lat - dog27.getPosition().lat();
            var lngDiff27_2 = wuwei.lng - dog27.getPosition().lng();
            var interpolatedLat27_2 = dog27.getPosition().lat() + (latDiff27_2 * ((currentValue - 7250) / 250));
            var interpolatedLng27_2 = dog27.getPosition().lng() + (lngDiff27_2 * ((currentValue - 7250) / 250));
            dog27.setPosition({ lat: interpolatedLat27_2, lng: interpolatedLng27_2 });
            }
        }
        if (currentValue >= 7500 && currentValue < 7750) {
            if (currentValue===7500){
                dog27.setPosition({ wuwei });
            }else
            {
            var latDiff27_3 = newCoords_dog27_1.lat - dog27.getPosition().lat();
            var lngDiff27_3 = newCoords_dog27_1.lng - dog27.getPosition().lng();
            var interpolatedLat27_3 = dog27.getPosition().lat() + (latDiff27_3 * ((currentValue - 7500) / 250));
            var interpolatedLng27_3 = dog27.getPosition().lng() + (lngDiff27_3 * ((currentValue - 7500) / 250));
            dog27.setPosition({ lat: interpolatedLat27_3, lng: interpolatedLng27_3 });
            }
        }
        if (currentValue >= 7750 && currentValue < 8000) {
            if (currentValue===7750){
                dog27.setPosition({ newCoords_dog27_1 });
            }else
            {
            var latDiff27_4 = newCoords_dog27_2.lat - dog27.getPosition().lat();
            var lngDiff27_4 = newCoords_dog27_2.lng - dog27.getPosition().lng();
            var interpolatedLat27_4 = dog27.getPosition().lat() + (latDiff27_4 * ((currentValue - 7750) / 250));
            var interpolatedLng27_4 = dog27.getPosition().lng() + (lngDiff27_4 * ((currentValue - 7750) / 250));
            dog27.setPosition({ lat: interpolatedLat27_4, lng: interpolatedLng27_4});
            }
        }
        var speeddog29=1;
        var speeddog30=1;
        ...
        var points_29 = [initialCoords_dog29, maliujia, taihai,zhangjiagang,newCoords_dog29,newCoords_dog29];
        var points_30 = [initialCoords_dog30, guli,kemolin,palk,maliujia, taihai,zhangjiagang,newCoords_dog30,newCoords_dog30];
        var points_31 = [initialCoords_dog31, guli,xilan,kemolin,palk,maliujia, taihai,zhangjiagang,newCoords_dog31,newCoords_dog31];
        var points_32 = [initialCoords_dog32, jibudi,guli,xilan,kemolin,palk,maliujia, taihai,zhangjiagang,newCoords_dog32,newCoords_dog32];
        var points_33 = [initialCoords_dog33, kailuo,jibudi,guli,xilan,kemolin,palk,maliujia, taihai,zhangjiagang,newCoords_dog33,newCoords_dog33];
    ...
    // 计算插值百分比
        var percentage_29 = speeddog29*(currentValue - 7000) % (1000 / (points_29.length-1)) / (1000 / (points_29.length-1));
        var percentage_30 = speeddog30*(currentValue - 7000) % (1000 / (points_30.length-1)) / (1000 / (points_30.length-1));
        var percentage_31 = speeddog31*(currentValue - 7000) % (1000 / (points_31.length-1)) / (1000 / (points_31.length-1));
        var percentage_32 = speeddog32*(currentValue - 7000) % (1000 / (points_32.length-1)) / (1000 / (points_32.length-1));
        var percentage_33 = speeddog33*(currentValue - 7000) % (1000 / (points_33.length-1)) / (1000 / (points_33.length-1));
    ...
    // 计算插值的新位置
        ...
        var interpolatedLat_29 = points_29[targetIndex_29].lat + latDiff * percentage_29*speeddog29;
        var interpolatedLng_29 = points_29[targetIndex_29].lng + lngDiff * percentage_29*speeddog29;
        ...
        var interpolatedLat_30 = points_30[targetIndex_30].lat + latDiff * percentage_30*speeddog30;
        var interpolatedLng_30 = points_30[targetIndex_30].lng + lngDiff * percentage_30*speeddog30;
        ...
        var interpolatedLat_31 = points_31[targetIndex_31].lat + latDiff * percentage_31*speeddog31;
        var interpolatedLng_31 = points_31[targetIndex_31].lng + lngDiff * percentage_31*speeddog31;
        ...
        var interpolatedLat_32 = points_32[targetIndex_32].lat + latDiff * percentage_32*speeddog32;
        var interpolatedLng_32 = points_32[targetIndex_32].lng + lngDiff * percentage_32*speeddog32;
        ...
        var interpolatedLat_33 = points_33[targetIndex_33].lat + latDiff * percentage_33*speeddog33;
        var interpolatedLng_33 = points_33[targetIndex_33].lng + lngDiff * percentage_33*speeddog33;

        
    // 设置dog229的位置
        dog29.setPosition({ lat: interpolatedLat_29, lng: interpolatedLng_29 });
        dog30.setPosition({ lat: interpolatedLat_30, lng: interpolatedLng_30 });     
        dog31.setPosition({ lat: interpolatedLat_31, lng: interpolatedLng_31 });
        dog32.setPosition({ lat: interpolatedLat_32, lng: interpolatedLng_32 });
        dog33.setPosition({ lat: interpolatedLat_33, lng: interpolatedLng_33 });
    ...
    if(currentValue >=8000 && currentValue <=9000){
        ...
        if(currentValue>=8000){
            ...
            dog23.setPosition(newCoords_dog23);
            dog24.setPosition(newcoords_dog24_2);
            dog27.setPosition(newcoords_dog27_2);
            dog28.setPosition(newCoords_dog28);
            dog29.setPosition(newCoords_dog29);
            dog30.setPosition(newCoords_dog30);
            dog31.setPosition(newCoords_dog31);
            dog32.setPosition(newCoords_dog32);
            dog33.setPosition(newCoords_dog33);
            //dog34.setPosition(initialCoords_dog34);
            
        }
        
        var points_34 = [initialCoords_dog34, newCoords_dog34_1,guli, xilan, palk, maliujia, newCoords_dog34_2, taihai, zhangjiagang,newCoords_dog34_3, newCoords_dog34_3];
    // 计算当前阶段的目标点的索引
